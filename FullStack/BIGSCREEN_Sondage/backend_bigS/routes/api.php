...
// Public route pour consulter les réponses via token unique (UUID)
Route::get('answers/{response_token}', [ResponseController::class, 'showByToken'])
    ->whereUuid('response_token')
    ->middleware('throttle:10,1');
// Public route pour consulter les réponses par ID numérique
Route::get('answers/{id}', [\App\Http\Controllers\ResponseController::class, 'show'])
    ->whereNumber('id');
Route::post('personal-data', [\App\Http\Controllers\PersonalDataController::class, 'store']);
