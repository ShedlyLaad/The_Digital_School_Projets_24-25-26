    ...
    const fetchChecklist = async () => {
      try {
        ...
        if (data) {
          ...
          setEditedTasks(Array.isArray(data.todo) ? data.todo : []);
        } else {
  ...
  return (
    <div className="checklist-container">
      {isEditing ? (
        ...
        <Card className="card" title={`Title: ${checklist.title}`} extra={
          ...
          <ul className="card-todo-list">
            {Array.isArray(checklist.todo) && checklist.todo.map((item, index) => (
